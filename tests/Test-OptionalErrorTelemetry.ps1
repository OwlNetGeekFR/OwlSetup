...
if ($dashboardAvailable) {
    ...
    $store = Get-Content (Join-Path $dashboardRoot 'Services\DashboardStore.cs') -Raw -Encoding UTF8
    ...
    Write-Host 'INFO - dashboard absent de ce checkout : les contrôles serveur restent exécutés dans le dépôt OwlSetup-Dashboard.' -ForegroundColor DarkGray
}
